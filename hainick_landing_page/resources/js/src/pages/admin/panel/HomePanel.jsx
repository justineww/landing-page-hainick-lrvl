...
const HomePanel = () => {
    ...
    const handleFileChange = async (e) => {
        ...
        // PHP tidak bisa membaca body multipart/form-data kalau method-nya PUT,
        // jadi kita selalu kirim POST dan sisipkan _method supaya Laravel
        // tetap mengarahkannya ke route PUT yang benar (method spoofing).
        const url = heroUrl
