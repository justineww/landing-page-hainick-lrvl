// TODO: Sambungkan ke API backend untuk fetch & update data Service
      ...
      <div className="panel-wrap">
        <div className="panel-header">
          <div className="panel-header-left">
            <h1 className="panel-page-title">◈ Service</h1>
            <p className="panel-page-sub">Kelola layanan yang ditawarkan</p>
          </div>
          <button className="panel-add-btn">+ Tambah Service</button>
        </div>
        ...
        <div className="panel-card">
          <div className="panel-card-header">
            <span className="panel-card-title">Daftar Service</span>
            <input
          ...
          <div className="panel-table-wrap">
            ...
            */}
            <div className="empty-state">
              ...
              <p>
                Klik <strong>+ Tambah Service</strong> untuk mulai.
              </p>
            </div>
          </div>
        </div>
